...
class NorthwindDataTransformer:
    ...
    def create_time_dimension(self):
        """Create time dimension table dynamically from order dates"""
    ...
    def create_employee_dimension(self):
        """Create employee dimension with territory information"""
...
if __name__ == "__main__":
    transformer = NorthwindDataTransformer()
    transformer.build_data_warehouse()
